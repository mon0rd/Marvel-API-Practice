...
class ComicsCharPage extends Component {
  ...
  render() {
    return (
      <div className="ComicsCharPage">
        <img
          src="/src/assets/Characters/img/jpeg/loki.jpg"
          alt="loki"
          className="ComicsCharPage_avatar"
        />
        <div className="ComicsCharPage_wrapper">
          <h2 className="title_h2">LOKI</h2>
          <p className="ComicsCharPage_text">
